...
socketio = SocketIO(app_socketio, cors_allowed_origins=['http://localhost:8080'])
...
def initialize_deepgram_connection():
    ...
    def on_message(self, result, **kwargs):
        ...
        if len(transcript) > 0:
            ...
            # make a fetch call to the flask app to get a response
            response = req.post("http://localhost:8080/talk", json={"user_speech": transcript})
            # print(response.json())
